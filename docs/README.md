...
- [`baostock-download-plan.md`](baostock-download-plan.md)：Milestone 7 独立
  `trading-codex-baostock` CLI、官方请求上限、全局串行门禁、data root 和恢复 contract。
- [`baostock-download-operations.md`](baostock-download-operations.md)：M7 初始化、冻结清单、
  人工 fetch、离线同步校验及故障恢复操作手册。
- [`baostock-data-plan.md`](baostock-data-plan.md)：拟议 Milestone 8 的 BaoStock API
