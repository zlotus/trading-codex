...
# The public provider limit is 50,000 attempts per day.  The simple downloader
# stops earlier so a small margin remains for accidental/manual requests from
# the same public IP.
DEFAULT_DAILY_ATTEMPT_STOP = 40_000
